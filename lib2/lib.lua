...
if not isfolder("melekhub") then
	makefolder("melekhub")
end

if not isfolder("melekhub/Assets") then
	makefolder("melekhub/Assets")
end

if not isfolder("melekhub/Configs") then
	makefolder("melekhub/Configs")
end

if not isfolder("melekhub/Themes") then
	makefolder("melekhub/Themes")
end
...
local Library do
	...
	Library = {
		...
		Folders = {
			Directory = "melekhub",
			Configs = "melekhub/Configs",
			Assets = "melekhub/Assets",
			Themes = "melekhub/Themes"
		},
	...
	local Themes = { -- edit this to change the theme
		["Default"] = {
			["Background"] = FromRGB(9, 22, 14),
			["Inline"] = FromRGB(14, 30, 19),
			["Border"] = FromRGB(30, 60, 40),
			["Shadow"] = FromRGB(0, 0, 0),
			["Text"] = FromRGB(255, 255, 255),
			["Inactive Text"] = FromRGB(185, 200, 190),
			["Accent"] = FromRGB(255, 98, 0),
			["Element"] = FromRGB(20, 42, 27),
	...
	Library.Notification = function(self, Text, Description, Duration)
		Duration = math.max(Duration or 5, 0.1)

		local Items = { } do
			Items["FakeBackground"] = Instances:Create("Frame", {
				Parent = Library.NotifHolder.Instance,
				Name = "\0",
				BackgroundTransparency = 1,
				AutomaticSize = Enum.AutomaticSize.Y,
				Size = UDim2New(0, 250, 0, 0),
				Visible = false
			})

			Items["Holder"] = Instances:Create("Frame", {
				Parent = Items["FakeBackground"].Instance,
				Name = "\0",
				...
				Size = UDim2New(1, 0, 1, 0),
				ZIndex = 5
			}) Items["Holder"]:AddToTheme({BackgroundColor3 = "Background"})
			...
			Items["Title"] = Instances:Create("TextLabel", {
				Parent = Items["Holder"].Instance,
				Name = "\0",
				FontFace = Library.Font or Enum.Font.Gotham,
		...
		Items["FakeBackground"].Instance.Visible = true
	...
	Library.Watermark = function(self, Name)
		...
		local Items = { } do
			...
			Items["Text"] = Instances:Create("TextLabel", {
				...
				Name = "\0",
				FontFace = Library.Font,
				TextColor3 = FromRGB(255, 188, 254),
				BorderColor3 = FromRGB(0, 0, 0),
				Text = Name,
				Size = UDim2New(0, 0, 0, 0),
				AnchorPoint = Vector2New(0, 0.5),
			...
			Instances:Create("UIStroke", {
				Parent = Items["Text"].Instance,
				Name = "\0",
				Color = FromRGB(15, 12, 16),
				Transparency = 0,
				Thickness = 1.5
			}):AddToTheme({Color = "Background"})

			Items["Branding"] = Instances:Create("Frame", {
				Parent = Library.WindowFrame or Library.Holder.Instance,
				Name = "\0",
				AnchorPoint = Vector2New(0, 1),
			...
			Instances:Create("UIListLayout", {
				Parent = Items["Branding"].Instance,
				Name = "\0",
				Padding = UDimNew(0, 2),
				SortOrder = Enum.SortOrder.LayoutOrder
			})
			...
			Items["BrandMelek"] = Instances:Create("TextLabel", {
				Parent = Items["BrandRow"].Instance,
				Name = "\0",
				FontFace = Library.Font,
				Text = "Melek",
				...
				BackgroundTransparency = 1,
				AutomaticSize = Enum.AutomaticSize.XY
			}) Items["BrandMelek"]:AddToTheme({TextColor3 = "Accent"})
			...
			Items["BrandHub"] = Instances:Create("TextLabel", {
				...
				FontFace = Library.Font,
				Text = "Hub",
				TextColor3 = FromRGB(41, 37, 45),
				TextSize = 18,
				TextXAlignment = Enum.TextXAlignment.Left,
				BackgroundTransparency = 1,
				AutomaticSize = Enum.AutomaticSize.XY
			}) Items["BrandHub"]:AddToTheme({TextColor3 = "Border"})

			local gameName = tostring(game.Name)
			task.spawn(function()
				pcall(function()
					local info = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId)
					if type(info) == "table" and tostring(info.Name) ~= "" then
						gameName = tostring(info.Name)
					end
				end)
				Items["BrandGame"].Instance.Text = gameName
			end)
			...
			Items["BrandGame"] = Instances:Create("TextLabel", {
				...
				BackgroundTransparency = 1,
				AutomaticSize = Enum.AutomaticSize.XY
			}) Items["BrandGame"]:AddToTheme({TextColor3 = "Text"})
		end
		...
		function Watermark:SetVisible(Bool)
			...
			Items["Branding"].Instance.Visible = Bool
		end
		...
		Library:Connect(RunService.RenderStepped, function()
			...
			Items["Text"].Instance.Text = string.format("%s | FPS: %s | Ping: %s ms", Name, tostring(FramesPerSecond), tostring(MathFloor(Stats.Network.ServerStatsItem["Data Ping"]:GetValue())))
		end)
	...
	Library.Window = function(self, Properties)
		...
		local Window = {
			Name = Properties.Name or Properties.name or "melekhub",
		...
		local Items = { } do
			...
			Library.WindowFrame = Items["MainFrame"].Instance
			...
			if IsMobile then 
				Items["FloatingButton"] = Instances:Create("TextButton", {
					...
					AutoButtonColor = false,
					Name = "\0",
					Position = UDim2New(0, 20, 0, 120),
					BorderColor3 = FromRGB(0, 0, 0),
					Size = UDim2New(0, 64, 0, 40),
					BorderSizePixel = 0,
					ZIndex = 127,
					BackgroundColor3 = Library.Theme.Background
				})  Items["FloatingButton"]:AddToTheme({BackgroundColor3 = "Background", TextColor3 = "Text"})
